...
use super::{NONE, OutputFormat, format_decimal, truncate};
        ...
        OutputFormat::Table => {
            ...
            let rows: Vec<Row> = activity
                ...
                .map(|a| Row {
                    ...
                    title: truncate(a.title.as_deref().unwrap_or(NONE), 35),
        ...
        OutputFormat::Table => {
            ...
            let rows: Vec<Row> = entries
                ...
                .map(|e| Row {
                    ...
                    trader: truncate(e.user_name.as_deref().unwrap_or(NONE), 20),
