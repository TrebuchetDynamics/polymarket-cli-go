...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CFDQoDEW.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_unR_wDB4.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_XoqzCQAV.mjs');
...
const starlightConfig = {"description":"Safe Polymarket SDK and CLI for Go","logo":{"src":"./src/assets/logo.svg","alt":"","replacesTitle":false},"social":{"github":{"label":"GitHub","url":"https://github.com/TrebuchetDynamics/polygolem"}},"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Getting Started","translations":{},"collapsed":false,"items":[{"label":"Introduction","translations":{},"slug":"","attrs":{}},{"label":"Installation","translations":{},"slug":"getting-started/installation","attrs":{}},{"label":"Quick Start","translations":{},"slug":"getting-started/quickstart","attrs":{}}]},{"label":"Guides","translations":{},"collapsed":false,"items":[{"label":"Market Discovery","translations":{},"slug":"guides/market-discovery","attrs":{}},{"label":"Orderbook Data","translations":{},"slug":"guides/orderbook-data","attrs":{}},{"label":"Paper Trading","translations":{},"slug":"guides/paper-trading","attrs":{}},{"label":"Bridge & Funding","translations":{},"slug":"guides/bridge-funding","attrs":{}},{"label":"Go-Bot Integration","translations":{},"slug":"guides/go-bot-integration","attrs":{}}]},{"label":"Concepts","translations":{},"collapsed":false,"items":[{"label":"Polymarket API Overview","translations":{},"slug":"concepts/polymarket-api","attrs":{}},{"label":"Markets, Events & Tokens","translations":{},"slug":"concepts/markets-events-tokens","attrs":{}},{"label":"Safety Model","translations":{},"slug":"concepts/safety","attrs":{}},{"label":"Architecture","translations":{},"slug":"concepts/architecture","attrs":{}}]},{"label":"Reference","translations":{},"collapsed":false,"items":[{"label":"CLI Commands","translations":{},"slug":"reference/cli","attrs":{}},{"label":"Go SDK","translations":{},"slug":"reference/sdk","attrs":{}},{"label":"Gamma API","translations":{},"slug":"reference/gamma-api","attrs":{}},{"label":"CLOB API","translations":{},"slug":"reference/clob-api","attrs":{}},{"label":"Stream API","translations":{},"slug":"reference/stream-api","attrs":{}}]}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"Polygolem"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};
