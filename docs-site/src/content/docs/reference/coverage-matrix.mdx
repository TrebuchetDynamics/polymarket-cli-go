...
| Deposit wallet lifecycle | `pkg/relayer`, `internal/auth`, `internal/rpc` | `deposit-wallet *` | SDK deploy+approve and CLI full onboard covered; funding remains explicit |
