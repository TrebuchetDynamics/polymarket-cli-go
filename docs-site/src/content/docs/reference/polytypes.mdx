...
`pkg/types` for Gamma, Data API, and read-only CLOB contracts. Enrichment,
rewards, authenticated CLOB account/trading, and stream contracts still use
internal protocol types until their public SDK slices are promoted.
