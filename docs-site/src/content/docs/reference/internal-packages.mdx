...
CLOB API client — read + write, EIP-712, POLY_1271, ERC-7739 signing.
...
Data API client — 11 methods. Positions, volume, leaderboards.
...
WebSocket market stream client with reconnect and dedup.

```go
import "github.com/TrebuchetDynamics/polygolem/internal/stream"
client := stream.NewMarketClient(stream.DefaultConfig("wss://ws-subscriptions-clob.polymarket.com/ws/"))
