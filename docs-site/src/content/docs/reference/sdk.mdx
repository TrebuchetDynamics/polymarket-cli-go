...
description: The public SDK surface — exact Go types, interfaces, and method signatures that form the polygolem API contract.
---

Public packages for consumption by `go-bot` and other Go projects. These are the stable API contracts — what you can depend on across minor versions.
...
### Contract: Methods — CLOB Auth (4 methods)
...
### Contract: Methods — Data API (10 methods)
