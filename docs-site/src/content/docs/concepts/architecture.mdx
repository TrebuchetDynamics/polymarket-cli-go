...
| **`pkg/`** | 9 | Public Go SDK contracts. Data API DTOs use public `pkg/types`; other type paths still need cleanup. |
...
| `internal/polytypes` | V2 protocol types — Market, Event, OrderBook, order payloads |
