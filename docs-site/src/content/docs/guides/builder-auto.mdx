...
The endpoint returns the CLOB L2 HMAC triple: `{ apiKey, secret, passphrase }`.
Those credentials authenticate CLOB balances, orders, trades, cancellations,
and same-address order placement.
