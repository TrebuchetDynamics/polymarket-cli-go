...
`pkg/types`. Authenticated CLOB account/trading, rewards, enrichment, and
stream signatures still expose implementation types from `internal/*`; treat
those paths as a documented SDK cleanup gap.
</Aside>
