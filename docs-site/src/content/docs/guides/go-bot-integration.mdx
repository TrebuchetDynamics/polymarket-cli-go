...
<Aside type="note">
Stability note: Gamma and Data API DTOs are public in `pkg/types`. Some CLOB,
enrichment, and stream signatures still expose implementation types from
`internal/*`; treat those paths as a documented SDK cleanup gap.
</Aside>
