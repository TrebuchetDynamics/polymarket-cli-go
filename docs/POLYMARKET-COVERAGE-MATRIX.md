...
| CLOB placement | Deposit-wallet limit and market/FOK order signing with CLOB V2 payload shape | `internal/clob`, `pkg/clob`, `pkg/universal` | `clob create-order`, `clob market-order` | `README.md`, `docs/COMMANDS.md`, Starlight CLOB page, `docs/SAFETY.md` | CLOB order-signing and placement tests, public SDK boundary test |
